...
import '../css/livetracking.css'; // Only import this to avoid conflicts
...
const LiveTracking = () => {
    ...
    useEffect(() => {
        if (!mapInstance.current) {
            ...
            // 🔥 IMPORTANT: Force Map Resize when it goes full screen
            setTimeout(() => { map.invalidateSize(); }, 500);
            setTimeout(() => { map.invalidateSize(); }, 2000); // Check again
        }
    }, []);
