...
const TripView = () => {
    ...
    // Fetch Trip Data & User ID
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, async (user) => {
            if (user && id) {
                setUserUid(user.uid); // Store UID
                try {
    ...
    const handleDeleteTrip = async () => {
        ...
        try {
            ...
            try {
                ...
                console.log("No file to delete or error:", err);
            }
            ...
            <div className="dashboard-content">
                ...
                <div className="trip-container">
                    ...
                    <div className="tv-grid">
                        ...
                        <TripCard icon="fa-stopwatch" label="Moving Time" value={`${Math.floor(trip?.movingDuration)} min`} color="#f64e60" />
                        <TripCard icon="fa-tachometer-alt" label="Top Speed" value={`${trip?.topSpeed} km/h`} color="#ff4d4d" />
