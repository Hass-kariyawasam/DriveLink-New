...
import { auth, db, database } from '../firebase'; // database import කළා (Realtime DB සඳහා)
import { collection, getDocs } from 'firebase/firestore';
import { ref, onValue } from 'firebase/database'; // Realtime Listener
...
const VehicleHealth = () => {
    const [stats, setStats] = useState({
        ...
        avgConsumption: 0,
        totalIdleTime: 0,
        batteryVoltage: 12.6 // Default Value
    });
        ...
        const unsubscribeAuth = onAuthStateChanged(auth, async (user) => {
            if (user) {
                ...
                try {
                    ...
                    // Set Device ID for Realtime DB (Battery)
                    // Note: You need to fetch deviceId from user profile first usually
                    // For now, assuming you handle deviceId fetching separately or hardcode for testing
    ...
    // 2. Battery Listener (Optional - If you have deviceId)
    useEffect(() => {
        if (deviceId) {
                    ...
                    <div className="vh-grid">
                        ...
                        <div className="vh-card">
                            ...
                            <div className="vh-info">
                                ...
                                <p className="sub-text">{stats.batteryVoltage > 12 ? 'Good Condition' : 'Check Battery'}</p>
                            </div>
                        </div>
