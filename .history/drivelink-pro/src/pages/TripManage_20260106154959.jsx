...
// Icons Config (Ensure images exist in public/icon/)
...
const DARK_MAP = 'https://mt1.google.com/vt/lyrs=y&x={x}&y={y}&z={z}'; // Google Hybrid (Better visibility)
        ...
        <Layout>
            <div className="dashboard-content">
                ...
                <div className="map-wrapper">
                    ...
                    {/* Top Right Controls: Live Badge + Map Toggle */}
