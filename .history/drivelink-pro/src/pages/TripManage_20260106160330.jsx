        ...
        <Layout>
            <div className="dashboard-content">
                ...
                <div className="map-wrapper">
                    ...
                    {/* NEW CAPSULE SPEEDOMETER (Bottom Center) */}
                    <div className="speed-capsule">
                        <i className="fas fa-gauge-high speed-icon"></i>
                ...
                <div className="trip-info-grid">
                    ...
                    <Card icon="fa-route" label="Range" value={`${stats.range.toFixed(0)} km`} color="#ffc107" />
                </div>
