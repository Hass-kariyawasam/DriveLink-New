                            ...
                            <div className="tr-map-header">
                                <div className="tr-trip-title">
                                    ...
                                    <div className="tr-trip-meta">
                                        ...
                                        <span className="tr-meta-item"><i className="fas fa-road" style={{color:'#1bc5bd'}}></i> {selectedTrip.distance} km</span>
                                        <span className="tr-meta-item"><i className="fas fa-parking" style={{color:'#ffa800'}}></i> {selectedTrip.stops ? selectedTrip.stops.length : 0} Stops</span>
                                    </div>
                                </div>
                                <button className="tr-close-btn" onClick={() => setSelectedTrip(null)}>
