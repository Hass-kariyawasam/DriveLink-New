...
const BatteryWidget = ({ sensorData }) => {
    ...
    // Battery Percentage Logic - Maximum 13.5V (Charging State)
    let percentage;
    if (voltage >= 13.5) {
        percentage = 100; // Charging - Maximum
    } else if (voltage >= 12.7) {
        percentage = 90 + ((voltage - 12.7) / 0.8) * 10; // 12.7V-13.5V = 90%-100%
    } else if (voltage >= 12.4) {
        percentage = 75 + ((voltage - 12.4) / 0.3) * 15; // 12.4V-12.7V = 75%-90%
    } else if (voltage >= 12.2) {
        percentage = 50 + ((voltage - 12.2) / 0.2) * 25; // 12.2V-12.4V = 50%-75%
    } else if (voltage >= 12.0) {
        percentage = 25 + ((voltage - 12.0) / 0.2) * 25; // 12.0V-12.2V = 25%-50%
    } else if (voltage >= 11.8) {
        percentage = ((voltage - 11.8) / 0.2) * 25; // 11.8V-12.0V = 0%-25%
    } else {
        percentage = 0;
    }
    
    // Simple round percentage (78%, 79% etc.)
    ...
    // Charging status - Maximum charging voltage 13.5V
    const isCharging = voltage > 13.5;
